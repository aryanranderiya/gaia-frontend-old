...
}: // onDelete,
{
  ...
  return (
    <Link to={`./${note.id}`}>
      <div
        className="bg-white/20 hover:bg-[#00bbff80] hover:-translate-y-1 transition-all min-w-[250px] max-w-[250px] max-h-[250px] rounded-lg text-foreground flex p-[1em] flex-col justify-start overflow-hidden gap-1 cursor-pointer h-full relative"
