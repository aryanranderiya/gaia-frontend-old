...
export default function LandingPage1Layout({
  ...
  return (
    <div className="sm:h-[70vh] sm:min-h-fit h-screen flex flex-col justify-start items-center sm:gap-7 w-full p-4 bg-zinc-950 rounded-3xl outline outline-zinc-900 hover:outline-primary transition-all">
