...
export default function LandingPage1Layout({
  ...
  return (
    <div
      className={cn(
        "sm:h-full sm:min-h-fit flex flex-col justify-start items-center sm:gap-7 w-full p-4 bg-zinc-950 rounded-3xl outline outline-zinc-900 hover:outline-primary transition-all",
        className
      )}
    >
