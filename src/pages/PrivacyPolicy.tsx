  ...
  return (
    <div className="privacy-policy p-4">
      ...
      <ul className="list-disc ml-6 mb-4">
        <li>
          <strong>Personal Information:</strong> Information you provide during
          account creation, such as name, email address, and payment details.
        </li>
        <li>
      ...
      <p className="mb-4">
        ...
        of significant changes by posting a notice on our website or via email.
      </p>
      ...
      <p className="mb-4">Email: aryan.k.randeriya@gmail.com</p>
    </div>
  );
};
