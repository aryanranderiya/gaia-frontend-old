  ...
  return (
    <div className="terms-of-service p-6">
      ...
      <p className="mb-4">
        ...
        assistant services (the “Service”), you agree to comply with these Terms
      ...
      <p className="mb-4">
        ...
        Policy, and any additional terms provided for specific features. If you
      ...
      <ul className="list-disc ml-6 mb-4">
        ...
        <li>
          Paid Features: Some advanced features and functionalities may require
          a paid subscription or one-time payment.
        </li>
        <li>
      ...
      <p className="mb-4">
        All content, trademarks, and technology in the Service are owned by GAIA
      ...
      <p className="mb-4">
        ...
        and analyze your submitted data (e.g., text, files) solely for providing
        the Service. You retain ownership of your data.
      </p>
      ...
      <p className="mb-4">
        ...
        revenue, or profits, arising from the use of the Service.
      </p>
